...
export function KPICards({ currentLog, summary }: KPICardsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 select-none">
      ...
      <div className="bg-[#141414] rounded-xl p-6 border border-white/10 shadow-lg flex flex-col justify-between relative overflow-hidden group">
        <div className="absolute top-0 right-0 w-40 h-40 bg-white/5 rounded-full blur-3xl group-hover:bg-white/10 transition-all duration-300" />
        ...
        <div>
          <div className="flex justify-between items-start gap-2">
            ...
            <span className="text-xs font-mono text-white/50 px-2 py-0.5 bg-white/5 rounded-lg border border-white/10">
          ...
          <div className="my-5 grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-white/45 font-medium">Programadas</p>
              <div className="flex items-baseline gap-1 mt-0.5">
                <span className="text-2xl font-bold font-mono text-white/90">
                  {numFmt(currentLog.toneladasProgramadas, 0)}
                </span>
                <span className="text-sm text-white/40 font-medium">t</span>
              </div>
            </div>
            <div>
              <p className="text-xs text-white/45 font-medium font-sans">Despachadas</p>
              <div className="flex items-baseline gap-1 mt-0.5">
                <span className="text-2xl font-bold font-mono text-blue-400">
                  {numFmt(currentLog.toneladasDespachadas, 2)}
                </span>
                <span className="text-sm text-blue-400/70 font-medium">t</span>
              </div>
            </div>
          </div>

          {/* TRUCK SVG WITH LIQUID brine level reflecting actual dispatch compliance */}
          <div className="w-full h-28 my-3 bg-[#0A0A0A] rounded-xl relative flex items-center justify-center p-2 overflow-hidden border border-white/10">
            ...
            <svg viewBox="0 0 160 70" className="w-44 h-24 relative z-10">
              {/* Ground road line */}
        ...
        <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
          <span className="text-xs text-white/40 font-semibold uppercase flex items-center gap-1">
            <Percent className="w-4 h-4 text-blue-500" /> Cumplimiento Diario
          </span>
          <span className={`text-sm font-bold font-mono px-2 py-0.5 rounded-lg border ${getStatusColor(tonCompliance)}`}>
            {numFmt(tonCompliance, 1)}%
          </span>
        </div>
        
        {/* Progress horizontal Indicator bar */}
        <div className="w-full bg-[#0A0A0A] h-2 rounded-full mt-2 overflow-hidden">
          <div
      ...
      <div className="bg-[#141414] rounded-xl p-6 border border-white/10 shadow-lg flex flex-col justify-between relative overflow-hidden group">
        ...
        <div>
          ...
          <div className="my-5 grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-white/45 font-medium">Programados</p>
              <div className="flex items-baseline gap-1 mt-0.5">
                <span className="text-2xl font-bold font-mono text-white/90">
                  {intFmt(currentLog.viajesProgramados)}
                </span>
                <span className="text-sm text-white/40 font-medium">Viajes</span>
              </div>
            </div>
            <div>
              <p className="text-xs text-white/45 font-medium">Realizados</p>
              <div className="flex items-baseline gap-1 mt-0.5">
                <span className="text-2xl font-bold font-mono text-emerald-400">
                  {intFmt(currentLog.viajesRealizados)}
                </span>
                <span className="text-sm text-emerald-400/80 font-medium">Viajes</span>
              </div>
            </div>
          </div>

          {/* VISUAL SHUTTLE ANIMATION RENDER */}
          <div className="w-full h-28 my-3 bg-[#0A0A0A] rounded-xl relative flex flex-col justify-center gap-2 px-4 border border-white/10">
            {/* Track 1: Backwards shadow */}
            <div className="relative w-full h-7 bg-white/5 rounded-md border border-white/5 flex items-center justify-between px-2 overflow-hidden">
              <span className="text-[10px] text-white/30 font-mono tracking-wider">LÍNEA DE MEZCLADO</span>
              <div className="flex gap-2">
                <div className="w-6 h-1 bg-blue-500/10 rounded animate-pulse" />
                <div className="w-4 h-1 bg-emerald-500/15 rounded" />
              </div>
            </div>
            {/* Track 2: Animated vehicle lane */}
            <div className="relative w-full h-10 bg-white/5 rounded-md flex items-center overflow-hidden border border-white/5">
              ...
              <div className="flex gap-12 items-center w-max animate-[marquee_12s_linear_infinite]">
                <div className="flex items-center gap-1.5 bg-blue-900/10 border border-blue-500/10 px-2 py-1 rounded text-blue-300">
                  <Truck className="w-4 h-4 text-blue-400" />
                  <span className="text-xs font-mono">LITIO-07</span>
                </div>
                <div className="flex items-center gap-1.5 bg-emerald-950/10 border border-emerald-500/10 px-2 py-1 rounded text-emerald-300">
                  <Truck className="w-4 h-4 text-emerald-400" />
                  <span className="text-xs font-mono">LITIO-14</span>
                </div>
                <div className="flex items-center gap-1.5 bg-blue-950/10 border border-blue-400/10 px-2 py-1 rounded text-blue-300 animate-pulse">
                  <Truck className="w-4 h-4 text-cyan-400" />
                  <span className="text-xs font-mono">LITIO-11</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
          <span className="text-xs text-white/40 font-semibold uppercase flex items-center gap-1">
            <Route className="w-4 h-4 text-blue-500" /> Vueltas Diarias
          </span>
          <span className={`text-sm font-bold font-mono px-2 py-0.5 rounded-lg border ${getStatusColor(tripsCompliance)}`}>
      ...
      <div className="bg-[#141414] rounded-xl p-6 border border-white/10 shadow-lg flex flex-col justify-between relative overflow-hidden group xl:col-span-1">
        <div className="absolute top-0 right-0 w-40 h-40 bg-white/5 rounded-full blur-3xl group-hover:bg-white/10 transition-all duration-300" />
        ...
        <div>
          <div className="flex justify-between items-start gap-2">
            ...
            <span className="text-xs font-semibold text-blue-400 px-2 py-0.5 bg-blue-500/10 rounded-lg border border-blue-500/20 flex items-center gap-1 font-mono">
              <TrendingUp className="w-4 h-4" /> ACUM.
            </span>
          </div>
          ...
          <div className="my-[13px] space-y-3">
            ...
            <div className="bg-[#0A0A0A] p-3 rounded-lg border border-white/5">
              ...
              <div className="w-full bg-[#141414] h-1.5 rounded-full mt-1.5 overflow-hidden">
                <div
        ...
        <div className="mt-2.5 pt-2 border-t border-white/5 flex items-center justify-between">
          <span className="text-xs text-white/40 font-semibold uppercase flex items-center gap-1">
            <CalendarCheck className="w-4 h-4 text-blue-500" /> Estado Mensual
          </span>
          <span className={`text-sm font-bold font-mono px-2 py-0.5 rounded-lg border ${getStatusColor(summary.cumplimientoTonelaje)}`}>
      ...
      <div className="bg-[#141414] rounded-xl p-6 border border-white/10 shadow-lg flex flex-col justify-between relative overflow-hidden group">
        <div className="absolute top-0 right-0 w-40 h-40 bg-white/5 rounded-full blur-3xl transition-all duration-300" />
        ...
        <div>
          <div className="flex justify-between items-start gap-2">
            ...
            <span className="text-xs font-semibold text-blue-400 px-2 py-0.5 bg-blue-500/10 rounded-lg border border-blue-500/10">
              Acum. Mes
            </span>
          </div>
          ...
          <div className="my-[13px] grid grid-cols-12 gap-2 items-center">
            ...
            <div className="col-span-7 space-y-3">
              <div>
                <p className="text-xs text-white/40 font-medium">LCE Programado</p>
                <div className="flex items-baseline gap-0.5">
                  <span className="text-base font-bold font-mono text-white/85">
                    {intFmt(summary.lceProgramadoTotal)}
                  </span>
                  <span className="text-xs text-white/40 font-semibold uppercase font-sans">t</span>
                </div>
              </div>
              <div>
                <p className="text-xs text-white/45 font-medium">LCE Actual (SdA)</p>
                <div className="flex items-baseline gap-0.5">
                  <span className="text-lg font-extrabold font-mono text-blue-450 text-[#F0F0F0]">
                    {numFmt(summary.lceActualTotal, 2)}
                  </span>
                  <span className="text-xs text-blue-450 font-semibold uppercase font-sans text-blue-400">t</span>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-5 flex justify-center items-center relative">
              <svg viewBox="0 0 100 100" className="w-22 h-22 transform -rotate-90">
                {/* Background Ring */}
              ...
              <div className="absolute inset-x-0 inset-y-0 flex flex-col justify-center items-center">
                <span className="text-sm font-bold font-mono text-[#F0F0F0] leading-none">
                  {numFmt(summary.lceCumplimiento, 0)}%
                </span>
                <span className="text-[9px] text-white/40 uppercase font-semibold scale-90 tracking-wide mt-0.5">
                  Meta LCE
                </span>
              </div>
        ...
        <div className="mt-2.5 pt-2 border-t border-white/5 flex items-center justify-between">
          <span className="text-xs text-white/40 font-semibold uppercase flex items-center gap-1 mt-0.5 font-sans">
            <Layers className="w-4 h-4 text-blue-500" /> Nivel Pozas PQLC:
          </span>
          <span className={`text-xs font-semibold font-mono px-2 py-0.5 rounded border ${
