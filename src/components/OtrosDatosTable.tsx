...
export function OtrosDatosTable({ summary }: OtrosDatosTableProps) {
  ...
  return (
    <div className="bg-[#141414] rounded-xl border border-white/10 shadow-lg flex flex-col lg:flex-row overflow-hidden select-none">
      ...
      <div className="bg-[#0F0F0F] p-6 lg:w-28 flex flex-row lg:flex-col items-center justify-between lg:justify-center gap-4 border-b lg:border-b-0 lg:border-r border-white/10 relative">
        ...
        <span className="text-[10px] tracking-widest text-white/40 font-bold uppercase lg:mb-4">
          Resumen
        </span>
        
        {/* Large stylized rotated label */}
        <div className="lg:rotate-270 lg:transform lg:my-6 transition-transform duration-300">
          <span className="text-xl lg:text-3xl font-extrabold text-[#F0F0F0] capitalize tracking-wider flex items-center">
            {summary.mes}
          </span>
        </div>

        <div className="flex gap-1 items-center bg-blue-500/10 border border-blue-500/20 px-2 py-1 rounded text-[10px] text-blue-400 font-mono font-bold mt-auto">
          MTR
        </div>
      </div>
      ...
      <div className="flex-1 p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <h3 className="text-xs font-bold text-white/80 tracking-wider uppercase flex items-center gap-1.5 pb-2 border-b border-white/10">
            <Scale className="w-4 h-4 text-blue-500" />
            Volúmenes Acumulados
          </h3>
          
          <div className="space-y-3">
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-[#0A0A0A] border border-white/5 hover:bg-white/[0.02] transition-colors">
              <span className="text-xs text-white/50">Tonelaje Acumulado</span>
              <div className="text-right">
                <span className="text-sm font-bold font-mono text-white">
                  {numFmt(summary.tonelajeDespachadoAcumulado, 2)}
                </span>
                <span className="text-[10px] text-white/30 font-medium ml-1">t</span>
              </div>
            </div>

            <div className="flex items-center justify-between p-2.5 rounded-xl bg-[#0A0A0A] border border-white/5 hover:bg-white/[0.02] transition-colors">
              <span className="text-xs text-white/50">m³ Acumulados</span>
              <div className="text-right">
                <span className="text-sm font-bold font-mono text-white/90">
                  {intFmt(summary.m3Acumulados)}
                </span>
                <span className="text-[10px] text-white/30 font-medium ml-1">m³</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-[#0A0A0A] border border-white/5 hover:bg-white/[0.02] transition-colors">
              <span className="text-xs text-white/50">Promedio por Camión (Ton)</span>
              <div className="text-right">
                <span className="text-sm font-bold font-mono text-white">
            ...
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-[#0A0A0A] border border-white/5 hover:bg-white/[0.02] transition-colors">
              <span className="text-xs text-white/50">Promedio por Camión (Vol.)</span>
              <div className="text-right">
                <span className="text-sm font-bold font-mono text-white/90">
            ...
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-[#0A0A0A] border border-white/5 hover:bg-white/[0.02] transition-colors">
              <span className="text-xs text-white/50">Cantidad de Camiones (Viajes)</span>
              <div className="text-right font-bold font-mono text-white/90">
        ...
        <div className="space-y-4 md:col-span-2 lg:col-span-1">
          ...
          <div className="bg-[#0A0A0A] rounded-xl p-3 border border-white/5 flex flex-col justify-between h-[92px] hover:bg-white/[0.02] transition-colors">
            <div className="flex justify-between items-start">
              <div>
                <span className="text-[10px] text-white/40 uppercase font-semibold">Productividad Lograda</span>
                <div className="flex items-baseline gap-1.5 mt-0.5">
                  <span className={`text-xl font-extrabold font-mono ${isMetaAchieved ? "text-emerald-400" : "text-amber-400"}`}>
                    {numFmt(summary.productividadMes, 2)}
                  </span>
                  <span className="text-xs text-white/40">vs Meta {numFmt(summary.productividadMeta, 1)}</span>
                </div>
              </div>
            ...
            <div className="w-full bg-[#141414] h-1.5 rounded-full overflow-hidden mt-1 relative">
              <div
