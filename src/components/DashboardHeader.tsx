...
export function DashboardHeader({
  ...
  return (
    <header className="w-full bg-[#0F0F0F] text-[#F0F0F0] rounded-xl p-6 shadow-xl border border-white/10">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-6 pb-6 border-b border-white/10">
        ...
        <div className="flex items-center gap-4 self-start lg:self-center">
          <div className="relative flex items-center justify-center w-11 h-11 bg-blue-600 rounded-lg shadow-lg">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              <span className="font-bold text-xl tracking-widest text-[#F0F0F0]">
                NOVANDINO
              </span>
              <span className="text-[10px] uppercase font-bold bg-blue-500/10 border border-blue-500/20 text-blue-400 px-1.5 py-0.5 rounded font-mono">
                LITIO
              </span>
            </div>
        ...
        <div className="text-center lg:text-right flex-1 select-none">
          <h1 className="text-lg lg:text-xl font-light tracking-widest text-white uppercase">
            Despacho Diario <span className="text-white/40">| Cloruro de Litio</span>
          </h1>
          <p className="text-xs font-semibold tracking-widest text-blue-400 mt-1 uppercase">
            Subgerencia Logística Litio &bull; Despacho Litio
          </p>
          <p className="text-[10px] font-medium tracking-widest text-white/30 uppercase mt-0.5">
            Salar de Atacama
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 pt-6">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[10px] text-white/55 flex items-center gap-1.5 font-bold tracking-widest uppercase">
          ...
          <div className="flex gap-2 items-center">
            <select
              ...
              className="flex-1 bg-[#0A0A0A] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-[#F0F0F0] focus:outline-none focus:border-blue-500 transition-colors cursor-pointer shadow-inner scrollbar-thin"
          ...
          <p className="text-[11px] text-white/40 mt-1 font-mono italic">
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            <Upload className={`w-4 h-4 ${isCustomFileLoaded ? "text-emerald-400" : "text-blue-500"}`} />
            ...
            {isCustomFileLoaded && (
              <span className="text-[9px] bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 px-1 py-0.5 rounded font-mono uppercase">
                Activo
              </span>
            )}
          </div>
          ...
          {uploadStatus !== "idle" && (
            <div className={`flex items-center gap-1.5 text-[10px] p-1.5 rounded mt-1 font-medium ${
              ...
              {uploadStatus === "success" ? <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" /> : <AlertCircle className="w-3.5 h-3.5 text-rose-400 flex-shrink-0" />}
        ...
        <div className="flex flex-col gap-2 justify-end">
          ...
          <div className="grid grid-cols-2 gap-3 h-11">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-white hover:bg-gray-200 active:bg-gray-300 transition-colors text-black rounded-lg text-xs font-bold uppercase tracking-widest shadow-md active:scale-95"
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 rounded-lg text-xs font-bold uppercase tracking-widest transition-all shadow-md active:scale-95 ${
                isCustomFileLoaded
